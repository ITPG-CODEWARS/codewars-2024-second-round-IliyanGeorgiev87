...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="cpassword" required placeholder="Повторете парола">
      <select name="user_type">
         <option value="user">Потребител</option>
         <option value="admin">Администратор</option>
      </select>
      <input type="submit" name="submit" value="Регистриране" class="form-btn">
      <p>Имате създаден акоунт? <a href="login_form.php">Вписване</a></p>
   </form>
